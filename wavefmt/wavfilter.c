...
int test_canonical_filter(int argc, char *argv[])
{
    ...
    return wavefmt_filter(argv[1], argv[2], canonical_filter, can,
                          WAVEFMT_FLOAT, 4.0); 
}

int test_reverb_filter(int argc, char *argv[])
{
    int    b_indx[2] = {1, 3500};
    double b_val[2]  = {0.4, 0.4};
    int    a_indx[1] = {3000};
    double a_val[1]  = {0.6};
    struct circular_state *circ = circular_create(5000, 2, b_indx, b_val,
                                                        2, a_indx, a_val);
    ...
    return wavefmt_filter(argv[1], argv[2], circular_filter, circ,
                          WAVEFMT_FLOAT, 4.0); 
}

int main(int argc, char *argv[])
{
    return test_reverb_filter(argc, argv);
}
